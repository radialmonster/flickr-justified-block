...
/**
 * Build a string of data-* attributes from an associative array.
 *
 * Empty string values (except '0') are skipped. All keys and values are escaped.
 *
 * @param array<string, string|int> $attrs Key => value pairs (keys without 'data-' prefix).
 * @return string Space-separated data attributes.
 */
function flickr_justified_build_data_attrs(array $attrs): string {
    $parts = [];
