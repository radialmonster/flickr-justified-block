    ...
    function initJustifiedGallery() {
        ...
        grids.forEach(grid => {
            ...
            function processRows() {
                ...
                // Helper: flush accumulated cards into a justified row
                function flushRow(cards, ars) {
                    ...
                    if (rowHeightMode === 'fixed') {
                        ...
                        optimalHeight = calculateOptimalRowHeight(ars, containerWidth, gap);
                ...
                // Helper: create a solo full-width row for a single card
                ...
                for (let i = 0; i < allCards.length; i++) {
                    ...
                    if (isFullRow) {
                        // Flush any accumulated cards first
                        flushRow(currentRow, currentRowAspectRatios);
                        currentRow = [];
                        currentRowAspectRatios = [];

                        // Create a solo full-width row for this card
